...
//cloud://cloud1-2g0ebfued8397e7b.636c-cloud1-2g0ebfued8397e7b-1311724933/1.png
var board_screen ="https://636c-cloud1-2g0ebfued8397e7b-1311724933.tcb.qcloud.la/board3_screen.jpg?sign=c2231bc30e13614d35f2b85ee22c67a4&t=1652255559";
var img_test = "cloud://cloud1-2g0ebfued8397e7b.636c-cloud1-2g0ebfued8397e7b-1311724933/1.png";
import './markup.scss';
  ...
  buildHeader() {
    ...
    return (
      <View className="head">
        ...
        <Image className="thumbnail-img" src={board_screen} mode="widthFix"></Image>
        <View className="contain_box">
        <View className="desc">打卡成功</View>
  ...
  buildShare() {
    return (
      <View className="share-container at-row at-row__align--center" onClick={() => this.share()}>
        <View className="share-txt">分享：</View>
